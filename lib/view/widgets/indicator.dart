...
class LiquidCustomProgressIndicatorPage extends StatelessWidget {
  ...
  Path _buildSpeechBubblePath() {
    ...
    return Path()
      ..moveTo(0, 10)
      ..quadraticBezierTo(x+10, 0, 20, 10)
      ..quadraticBezierTo(x+30, 0, 40, 10)
      ..quadraticBezierTo(x+50, 0, 60, 10)
      ..quadraticBezierTo(x+70, 0, 80, 10)
      ..quadraticBezierTo(x+100, 30, 80, 50)
      ..quadraticBezierTo(x+70, 60, 60, 50)
      ..quadraticBezierTo(x+50, 60, 40, 50)
      ..quadraticBezierTo(x+30, 60, 20, 50)
      ..quadraticBezierTo(x+10, 60, 0, 50)
